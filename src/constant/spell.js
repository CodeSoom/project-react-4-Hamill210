// 20210718005153
// http://ddragon.leagueoflegends.com/cdn/11.14.1/data/en_US/summoner.json
...
const spell = {
  ...
  'data': {
    ...
    'SummonerTeleport': {
      ...
      'tooltip': 'After channeling for {{ channelduration }} seconds, your champion teleports to target allied structure, minion, or ward and grants a {{ msamount*100 }}% Move Speed boost for {{ msduration }} seconds.',
      'maxrank': 1,
      'cooldown': [
        0
      ],
    ...
    'Summoner_UltBook_Placeholder': {
      ...
      'rangeBurn': '400',
      'image': {
        'full': 'Summoner_UltBook_Placeholder.png',
        'sprite': 'spell0.png',
        'group': 'spell',
        'x': 192,
        'y': 48,
