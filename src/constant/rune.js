// 20210718011922
// https://ddragon.leagueoflegends.com/cdn/11.14.1/data/ko_KR/runesReforged.json
        ...
        "runes": [
          {
            ...
            "longDesc": "<b>이동 또는 행동을 방해받은</b> 상태의 챔피언에게 피해를 주면 레벨에 따라 10 ~ 45의 추가 고정 피해를 입힙니다.<br><br>재사용 대기시간: 4초<br><rules>방해 효과 이후 피해를 가할 때 활성화됩니다.</rules>"
          },
          {
            "id": 8139,
            "key": "TasteOfBlood",
      ...
      },
      {
        "runes": [
          ...
          },
          {
            ...
            "name": "유령 포로",
            "shortDesc": "자신이 설치한 와드의 지속시간이 끝나면 유령 포로 와드가 남아 발견될 때까지 시야를 밝히고, 생성된 유령 포로 와드 하나당 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'>적응형</lol-uikit-tooltipped-keyword>으로 공격력 또는 주문력 영구 증가 및 유령 포로 와드가 적 챔피언 발견 시 추가로 증가",
            "longDesc": "자신이 설치한 와드의 지속시간이 끝나면 유령 포로 와드가 남아 90초 동안 시야를 밝힙니다. 적 챔피언이 근처에 오면 유령 포로 와드를 몰아낼 수 있습니다.<br><br>유령 포로 와드가 생성되거나 유령 포로 와드가 적 챔피언을 발견할 때마다 최대 10회까지 중첩되는 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'><font color='#48C4B7'>적응형</font></lol-uikit-tooltipped-keyword>으로 추가 공격력 1.2 또는 추가 주문력 2의 효과를 얻습니다. <br><br>10회 중첩되면 10의 적응형 능력치를 부가적으로 획득합니다."
          },
          {
            "id": 8138,
            ...
            "name": "사냥의 증표",
            "shortDesc": "챔피언 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Takedown'>처치 관여</lol-uikit-tooltipped-keyword> 시마다 증표 획득. 개당 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'>적응형</lol-uikit-tooltipped-keyword>으로 공격력 또는 주문력 영구 증가 및 최대 개수 도달 시 추가 증가",
            "longDesc": "챔피언 처치에 관여하면 증표를 얻습니다. 증표 하나당 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'><font color='#48C4B7'>적응형</font></lol-uikit-tooltipped-keyword>으로 추가 공격력 1.2 또는 추가 주문력 2의 효과를 얻습니다. <br><br>증표 개수가 최대치인 10개에 도달하면 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'><font color='#48C4B7'>적응형</font></lol-uikit-tooltipped-keyword>으로 추가 공격력 6 또는 추가 주문력 10의 효과를 부가적으로 획득합니다.<br><br>적 챔피언 처치 관여 시마다 증표 1개를 얻습니다."
          }
        ]
      },
      {
        "runes": [
          {
            ...
            "name": "굶주린 사냥꾼",
            "shortDesc": "적 챔피언당 <b>1회</b> 한정 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Takedown'>처치 관여</lol-uikit-tooltipped-keyword> 시 <lifesteal>모든 피해 흡혈</lifesteal> 영구 획득 ",
            "longDesc": "<lifeSteal>모든 피해 흡혈</lifeSteal>: <i>현상금 사냥꾼</i> 중첩 1회당 1.5% <br><br>각 적 챔피언을 처치하는 데 처음으로 관여할 때마다 <i>현상금 사냥꾼</i> 중첩을 얻을 수 있습니다.<br><br><rules>광역 피해를 입히거나 소환물을 통해 피해를 입힐 때는 모든 피해 흡혈이 33%로 감소합니다.</rules>"
          },
          {
            "id": 8134,
            "key": "IngeniousHunter",
            ...
            "longDesc": "<b>아이템 가속</b>이 <attention>10</attention>+<i>현상금 사냥꾼</i> 중첩 1회당 <attention>5</attention> 증가합니다. (장신구 포함)<br><br>각 적 챔피언을 처치하는 데 처음으로 관여할 때마다 <i>현상금 사냥꾼</i> 중첩을 얻을 수 있습니다.<br><br><rules>아이템 가속은 재사용 대기시간이 있는 모든 아이템에 적용됩니다. </rules>"
          },
          {
            "id": 8105,
          ...
          },
          {
            ...
            "longDesc": "궁극기의 스킬 가속이 <attention>6</attention>+<i>현상금 사냥꾼</i> 중첩 1회당 <attention>5</attention> 증가합니다.<br><br>각 적 챔피언을 처치하는 데 처음으로 관여할 때마다 <i>현상금 사냥꾼</i> 중첩을 얻을 수 있습니다."
          }
        ]
      }
    ]
        ...
        "runes": [
          {
            ...
            "name": "빙결 강화",
            "shortDesc": "적 챔피언에 대한 첫 공격 시 둔화 적용(유닛당 재사용 대기시간 적용). 사용 아이템으로 챔피언 둔화 시 잠시 동안 둔화 구역을 생성하는 빙결 광선 발사",
            "longDesc": "적 챔피언을 기본 공격하면 2초 동안 둔화시킵니다. 둔화 효과는 지속시간 동안 강화됩니다.<li><i>원거리 공격</i>: 최대 30%~40% 둔화</li> <li><i>근접 공격</i>: 최대 45%~55% 둔화</li><br>사용 아이템으로 적 챔피언을 둔화시키면 빙결 광선을 발사해서 주변 지역을 5초 동안 얼립니다. 해당 범위의 모든 유닛은 60% 둔화됩니다.<br><br>재사용 대기시간: 유닛당 7~4초"
          },
          {
            "id": 8360,
          ...
          },
          {
            ...
            "longDesc": "주기적으로 다른 무작위 핵심 룬을 1회 사용할 수 있습니다.<br><br>핵심 룬을 사용하고 5~3초가 지나야 다음 핵심 룬을 사용할 수 있습니다. (원거리 챔피언의 경우 9~7초)<br><br><rules><br>준비된 핵심 룬을 40초 동안 사용하지 않으면 적 챔피언과의 전투에서 벗어날 때 새로운 핵심 룬이 준비됩니다.<br>여진은 여진을 발동할 수 있는 기본 스킬을 배운 챔피언만 사용할 수 있습니다.<br>포식자는 이미 장화를 구매한 챔피언만 사용할 수 있습니다.<br></rules>"
          }
        ]
      },
      {
        "runes": [
          {
            ...
            "name": "마법공학 점멸기",
            "shortDesc": "점멸이 재사용 대기 중일 때 <i>마법공학 점멸</i>로 대체됨<br><br><i>마법공학 점멸</i>: 정신 집중 후 다른 지점으로 순간 이동",
            "longDesc": "점멸이 재사용 대기 중일 때 <i>마법공학 점멸</i>로 대체됩니다.<br><br><i>마법공학 점멸</i>: 2초간 정신을 집중한 뒤 다른 지점으로 도약합니다.<br><br>재사용 대기시간: 20초. 챔피언과 전투에 돌입할 경우 10초의 재사용 대기시간이 시작됩니다."
          },
          {
            "id": 8304,
            "key": "MagicalFootwear",
            ...
            "name": "마법의 신발",
            "shortDesc": "게임 시작 후 12분에 장화 무료 획득. 그 전까지 신발류 아이템 구매 불가. 챔피언 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Takedown'>처치 관여</lol-uikit-tooltipped-keyword> 시마다 장화 획득 시점이 45초 앞당겨짐",
          ...
          },
          {
            ...
            "name": "완벽한 타이밍",
            "shortDesc": "초시계 키트 획득. 14분 후부터 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Stasis'>경직</lol-uikit-tooltipped-keyword> 효과 1회 사용 가능 <br><br><lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Takedown'>처치 관여</lol-uikit-tooltipped-keyword> 시마다 사용 가능 시점 120초씩 단축",
            "longDesc": "게임 시작 시 초시계 키트 아이템을 받습니다. 이 아이템은 14분 후 초시계 아이템으로 변합니다. 챔피언 처치 관여 시마다 이 시간이 120초 감소합니다.<br><br>초시계 아이템은 단 한 번 사용할 수 있으며, 사용 시 2.5초 동안 경직 효과를 얻습니다."
          }
        ]
      },
      {
        "runes": [
          {
            ...
            "longDesc": "외상으로 아이템을 구입할 수 있습니다. 외상 한도는 점차 증가합니다.<br><br>외상 비용: 50골드"
          },
          {
            "id": 8316,
          ...
          },
          {
            ...
            "longDesc": "비스킷 배달: 6분까지 2분마다 굳건한 의지의 완전한 비스킷 아이템을 얻습니다.<br><br>비스킷을 사용하면 잃은 체력과 마나의 10%를 회복합니다. 비스킷 하나를 사용하거나 판매하면 최대 마나가 영구적으로 50만큼 늘어납니다. <br><br><i>마나 없음:</i> 마나가 없는 챔피언은 마나 대신 잃은 체력의 12%를 회복합니다."
          }
        ]
      },
      {
        "runes": [
          ...
          },
          {
            ...
            "name": "쾌속 접근",
            "shortDesc": "<lol-uikit-tooltipped-keyword key='LinkTooltip_Description_ImpairMov'>이동을 방해받은</lol-uikit-tooltipped-keyword> 근처 적 챔피언에게 이동할 때 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_MS'>이동 속도</lol-uikit-tooltipped-keyword> 증가. 자신이 이동 방해 스킬을 맞힌 적에게 이동할 때는 추가 증가",
        ...
        "runes": [
          {
            ...
            "longDesc": "적 챔피언에게 연속으로 3회 기본 공격을 가하면 레벨에 따라 40 ~ 180의 추가 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_AdaptiveDmg'><font color='#48C4B7'>적응형 피해</font></lol-uikit-tooltipped-keyword>를 입히고 적의 약점을 노출시킵니다. 약점이 노출된 적은 6초 동안 모든 상대에게서 8 ~ 12%의 추가 피해를 받습니다."
          },
          {
            "id": 8008,
            "key": "LethalTempo",
            ...
            "name": "치명적 속도",
            "shortDesc": "챔피언에게 피해를 입히고 1.5초 후 치명적 속도 상태 돌입. 치명적 속도 상태에서는 공격 속도 대폭 증가 및 일시적으로 공격 속도 상한 초과 가능",
            "longDesc": "적 챔피언에게 피해를 주고 1.5초 후, 3초 동안 레벨에 따라 공격 속도가 40~110% 증가합니다. 적 챔피언을 공격하면 효과 지속시간이 6초까지 증가합니다.<br><br>재사용 대기시간: 6초<br><br>치명적 속도 상태에서는 일시적으로 최고 공격 속도 제한을 초과할 수 있습니다."
          },
          {
            "id": 8021,
            "key": "FleetFootwork",
            ...
            "longDesc": "공격 또는 이동 시 충전 중첩이 쌓입니다. 중첩이 100회에 도달하면 충전 상태로 다음 공격을 할 수 있습니다.<br><br>충전 상태로 공격 시 3~60(+추가 공격력의 0.3, +주문력의 0.2)에 해당하는 체력이 회복되며 1초 동안 <speed>이동 속도가 20%</speed> 증가합니다.<br><br>원거리 챔피언의 경우 미니언으로부터 받는 회복 효과가 20%만 적용됩니다."
          },
          {
            "id": 8010,
            "key": "Conqueror",
        ...
        "runes": [
          {
            ...
            "longDesc": "자신에 대한 체력 회복 초과분이 보호막으로 전환됩니다. 보호막은 10<scaleHealth>(+최대 체력의 10%)</scaleHealth>에 해당하는 피해까지 흡수할 수 있습니다.<br><br>보호막 전환율은 자신 또는 아군으로부터의 체력 회복 초과분의 20~100%입니다."
          },
          {
            "id": 9111,
            "key": "Triumph",
            ...
            "longDesc": "챔피언 처치 또는 어시스트 시 잃은 체력의 12%를 회복하며 추가로 20골드를 획득합니다. <br><br><hr><br><i>'가장 위험한 게임을 하는 자만이 진정 승리의 환희를 맛보았다고 말할 수 있다.' <br>—녹서스 검투사</i>"
          },
          {
            "id": 8009,
            "key": "PresenceOfMind",
            ...
            "longDesc": "적 챔피언에게 피해를 입히면 4초 동안 초당 마나 재생이 @RegenAmount@ (원거리 챔피언은 80%) 증가합니다. 기력 기반 챔피언은 초당 1.5의 기력을 얻습니다.<br><br>처치 관여 시 최대 마나 또는 기력의 15%를 돌려받습니다. "
          }
        ]
      },
      {
        "runes": [
          {
            ...
            "longDesc": "공격 속도가 3% 증가하며 <i>전설</i> 중첩당 1.5%의 공격 속도가 추가로 증가합니다. (<statGood>최대 전설 중첩 횟수: 10</statGood>)<br><br>챔피언 처치 관여, 에픽 몬스터 처치 관여, 대형 몬스터 처치, 미니언 처치 시마다 <i>전설</i> 중첩을 얻습니다."
          },
          {
            "id": 9105,
            "key": "LegendTenacity",
            ...
            "longDesc": "강인함이 5% 증가하며 <i>전설</i> 중첩당 2.5%의 강인함이 추가로 증가합니다. (<statGood>최대 전설 중첩 횟수: 10</statGood>)<br><br>챔피언 처치 관여, 에픽 몬스터 처치 관여, 대형 몬스터 처치, 미니언 처치 시마다 <i>전설</i> 중첩을 얻습니다."
          },
          {
            "id": 9103,
            "key": "LegendBloodline",
            ...
            "name": "전설: 핏빛 길",
            "shortDesc": "적 챔피언 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Takedown'>처치 관여</lol-uikit-tooltipped-keyword> 시 영구적으로 <b>생명력 흡수</b> 효과 획득. 다른 전설 룬에 비해 게임 초반에 약하고 후반에 강한 룬",
            "longDesc": "<i>전설</i> 중첩당 생명력 흡수가 0.6% 증가합니다. (<statGood>최대 전설 중첩 횟수: 15</statGood>)<br><br>챔피언 처치 관여, 에픽 몬스터 처치 관여, 대형 몬스터 처치, 미니언 처치 시마다 <i>전설</i> 중첩을 얻습니다."
          }
        ]
      },
      {
        ...
        "runes": [
          {
            ...
            "longDesc": "전투 중 4초마다 챔피언에 대한 기본 공격 시 다음 효과를 얻습니다.<li>자신 최대 체력의 4%에 해당하는 추가 마법 피해</li><li>자신 최대 체력의 2%에 해당하는 체력 회복</li><li>영구적으로 체력 5 증가</li><br><rules><i>원거리 챔피언:</i> 피해량, 회복량, 체력 영구 증가량이 40% 감소합니다.</rules><br>"
          },
          {
            "id": 8439,
            "key": "Aftershock",
            ...
            "name": "여진",
            "shortDesc": "적 챔피언을 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Immobilize'>이동 불가</lol-uikit-tooltipped-keyword> 상태로 만들면 방어력/마법 저항력 증가 및 잠시 후 주변에 큰 마법 피해",
            "longDesc": "적을 이동 불가 상태로 만들면 2.5초 동안 35+추가 방어력 및 마법 저항력의 80%만큼 방어력과 마법 저항력이 증가하며 폭발이 일어나 근처 적에게 마법 피해를 줍니다.<br><br>피해량: 25~120 (+추가 체력의 8%)<br>재사용 대기시간: 20초<br><br>여진 추가 저항력: 80~150 (레벨에 비례)<br>"
          },
          {
            "id": 8465,
            "key": "Guardian",
            ...
            "longDesc": "자신으로부터 350유닛 내에 있는 아군이나 자신이 스킬의 대상으로 삼은 아군을 2.5초 동안 <i>보호</i>합니다. <i>보호</i>하는 중 자신과 아군 중 한 명이 <i>보호</i>의 지속시간 동안 어느 정도 피해를 입으면 둘 모두에게 1.5초 동안 보호막이 생성됩니다.<br><br>재사용 대기시간: <scaleLevel>70~40</scaleLevel>초<br>보호막 흡수량: <scaleLevel>70~150</scaleLevel>+주문력의 <scaleAP>15%</scaleAP>+추가 체력의 <scalehealth>9%</scalehealth><br>최종 기준치: 감소 후 피해량 <scaleLevel>90~250</scaleLevel>"
          }
        ]
      },
      {
        "runes": [
          {
            ...
            "longDesc": "포탑으로부터 600 범위 안에 있을 경우 3초에 걸쳐 포탑에 대한 강력한 공격을 충전합니다. 충전된 공격은 100(+최대 체력의 35%)에 해당하는 추가 물리 피해를 입힙니다. <br><br>재사용 대기시간: 45초"
          },
          {
            "id": 8463,
            "key": "FontOfLife",
          ...
          },
          {
            ...
            "name": "보호막 강타",
            "shortDesc": "보호막을 얻으면 적 챔피언에게 다음 기본 공격 시 추가 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'><font color='#48C4B7'>적응형</font></lol-uikit-tooltipped-keyword> 피해",
            "longDesc": "보호막이 지속되는 동안 레벨에 따라 <scaleLevel>1~10</scaleLevel>의 방어력과 마법 저항력을 얻습니다.<br><br>새로운 보호막을 얻으면 적 챔피언에게 다음 기본 공격 시 <scaleLevel>5~30</scaleLevel><scaleHealth>(+추가 체력의 1.5%)</scaleHealth><scaleMana>(+새로운 보호막 흡수량의 8.5%)</scaleMana>에 해당하는 추가 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'><font color='#48C4B7'>적응형</font></lol-uikit-tooltipped-keyword> 피해를 입힙니다.<br><br>이 효과는 보호막이 사라진 후 최대 2초까지 발동 가능합니다."
          }
        ]
      },
      {
        ...
        "runes": [
          {
            ...
            "longDesc": "근처에서 몬스터 또는 적 미니언이 8마리 죽을 때마다 생명의 정수를 흡수해 최대 체력이 영구적으로 3씩 증가합니다.<br><br>몬스터 또는 적 미니언을 120마리 흡수하면 최대 체력이 추가로 3.5% 증가합니다."
          },
          {
            "id": 8453,
            "key": "Revitalize",
        ...
        "runes": [
          {
            ...
            "longDesc": "적 챔피언을 기본 공격 또는 스킬로 공격하면 콩콩이를 보내 레벨에 따라 10~40(+<scaleAP>주문력의 0.1</scaleAP>)(+<scaleAD>추가 공격력의 0.15</scaleAD>)만큼 피해를 입힙니다.<br><br>아군에게 스킬로 강화 효과 또는 보호막을 적용하면 콩콩이를 보내 레벨에 따라 35~80(+<scaleAP>주문력의 0.25</scaleAP>)(+<scaleAD>추가 공격력의 0.4</scaleAD>)만큼 피해를 흡수하는 보호막을 씌웁니다.<br><br>콩콩이는 자신에게 돌아오기 전까지 다른 대상에게 보낼 수 없습니다."
          },
          {
            "id": 8229,
            "key": "ArcaneComet",
          ...
          },
          {
            ...
            "longDesc": "4초 안에 한 챔피언에게 기본 공격 또는 <b>개별</b> 스킬 3회를 적중시키면 레벨에 따라 <speed>15~40%의 이동 속도</speed>와 75%의 둔화 저항 효과를 얻습니다. <hr>근접 챔피언의 경우 <speed>이동 속도가 30~60%</speed>까지 증가합니다.<hr>지속시간: 3초<br>재사용 대기시간: 10~30초"
          }
        ]
      },
      {
        "runes": [
          {
            ...
            "longDesc": "마법 피해를 받아 체력이 30% 이하가 될 경우, 4초 동안 레벨에 비례해 40 ~ 120 (<scaleAP>+주문력의 0.1</scaleAP> 및 <scaleAD>+추가 공격력의 0.15</scaleAD>)의 마법 피해를 흡수하는 보호막이 생성됩니다.<br><br>재사용 대기시간: 60초"
          },
          {
            "id": 8226,
            "key": "ManaflowBand",
            ...
            "longDesc": "적 챔피언에게 스킬을 적중하면 최대 마나가 영구적으로 25만큼 증가합니다. (최대 마나량: 250)<br><br>최대 마나량 250에 도달하면 5초마다 잃은 마나의 1%를 회복합니다.<br><br>재사용 대기시간: 15초"
          },
          {
            "id": 8275,
            "key": "NimbusCloak",
            ...
            "longDesc": "소환사 주문 사용 후 2초 동안 <speed>이동 속도</speed>가 증가하고 유닛을 통과할 수 있습니다.<br><br>증가: 소환사 주문 재사용 대기시간에 따라 <speed>이동 속도가 5%~25%</speed> 증가합니다. (재사용 대기시간이 길수록 <speed>이동 속도</speed>가 더 많이 증가합니다.) "
          }
        ]
      },
      {
        "runes": [
          {
            ...
            "name": "깨달음",
            "shortDesc": "다음 레벨이 되면 추가 효과 획득:<br>5레벨: <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_CDR'>스킬 가속</lol-uikit-tooltipped-keyword> +5 <br>8레벨: <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_CDR'>스킬 가속</lol-uikit-tooltipped-keyword> +5 <br>11레벨: 챔피언 처치 관여 시 기본 스킬의 남은 재사용 대기시간 20% 감소",
            "longDesc": "다음 레벨이 되면 추가 효과 획득:<br>5레벨: <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_CDR'>스킬 가속</lol-uikit-tooltipped-keyword> +5 <br>8레벨: <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_CDR'>스킬 가속</lol-uikit-tooltipped-keyword> +5 <br>11레벨: 챔피언 처치 관여 시 기본 스킬의 남은 재사용 대기시간 20% 감소<br>"
          },
          {
            "id": 8234,
            "key": "Celerity",
          ...
          },
          {
            ...
            "longDesc": "체력이 70% 이상일 경우 레벨에 따라 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'><font color='#48C4B7'>적응형</font></lol-uikit-tooltipped-keyword>으로 추가 공격력 최대 18 또는 추가 주문력 최대 30의 효과를 얻습니다. <br><br>1레벨에 1.8의 공격력 또는 3의 주문력을 얻습니다. "
          }
        ]
      },
      {
        "runes": [
          ...
          },
          {
            ...
            "name": "물 위를 걷는 자",
            "shortDesc": "강에 있을 때 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_MS'>이동 속도</lol-uikit-tooltipped-keyword>를 얻고 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'>적응형</lol-uikit-tooltipped-keyword>으로 주문력 또는 공격력 증가",
            "longDesc": "강에 있을 때 <speed>이동 속도가 25</speed> 증가하고 레벨에 비례하여 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'><font color='#48C4B7'>적응형</font></lol-uikit-tooltipped-keyword>으로 추가 공격력 최대 18 또는 추가 주문력 최대 30의 효과를 얻습니다.<br><br><hr><br><i>굽이치는 강물처럼 빠르고 깜짝 놀란 협곡 바위 게처럼 날렵하게 움직이리라.</i><br>"
          },
          {
            "id": 8236,
            "key": "GatheringStorm",
